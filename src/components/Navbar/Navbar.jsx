    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/ahteshamull"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-shop_light_green"
          >
            <FaGithub size={24} />
          </a>
          <a
            href="https://www.linkedin.com/in/ahteshamul-hasan?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-shop_light_green"
          >
        ...
        <div className="md:hidden">
          {isOpen ? (
            <FiX
              className="text-3xl text-shop_light_green cursor-pointer"
